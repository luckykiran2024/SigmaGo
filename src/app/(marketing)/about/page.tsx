    ...
    <div className="bg-[#F7F8FA] text-[#17200F] font-inter">
      ...
      <section className="py-[clamp(64px,7vw,110px)] border-b border-border">
        <div className="max-w-[1240px] mx-auto px-5 sm:px-8 space-y-6 animate-fade-up">
          ...
          >
            Built for companies that intend to <span className="text-[#C9A227]">[last.]</span>
          </h1>
          
          <p 
            className="text-[#667085] max-w-2xl font-medium leading-[1.7]"
      ...
      <section className="py-[clamp(64px,7vw,110px)] border-b border-border bg-[#F7F8FA]">
        <div className="max-w-[1240px] mx-auto px-5 sm:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Why We Exist */}
            <div className="bg-white border border-border rounded-lg p-8 shadow-[0_10px_28px_rgba(60,55,30,0.10)] hover:-translate-y-1 hover:shadow-lg transition duration-200 ease-out space-y-4 animate-fade-up">
              <div className="w-10 h-10 rounded-lg bg-[#C9A227]/10 text-[#C9A227] flex items-center justify-center">
                <Sparkles className="w-5 h-5" />
              </div>
              <h3 className="font-sans text-xl font-bold text-[#17200F]">Why we exist</h3>
            ...
            {/* What We Believe */}
            <div className="bg-white border border-border rounded-lg p-8 shadow-[0_10px_28px_rgba(60,55,30,0.10)] hover:-translate-y-1 hover:shadow-lg transition duration-200 ease-out space-y-4 animate-fade-up" style={{ animationDelay: '60ms' }}>
              <div className="w-10 h-10 rounded-lg bg-[#C9A227]/10 text-[#C9A227] flex items-center justify-center">
                <Heart className="w-5 h-5" />
              </div>
              <h3 className="font-sans text-xl font-bold text-[#17200F]">What we believe</h3>
              <p className="text-xs text-[#4B5347] leading-relaxed font-inter">
      ...
      <section className="py-[clamp(64px,7vw,110px)] bg-[#F1EEE4] text-center border-b border-border">
        <div className="max-w-xl mx-auto px-5 sm:px-8 space-y-6 animate-fade-up">
          <h2 className="font-sans text-[clamp(28px,3.6vw,44px)] font-bold text-[#17200F] leading-[1.12]">
            Start keeping your <span className="text-[#C9A227]">[decisions.]</span>
          </h2>
          <div className="pt-2">
            <a
              href={mailtoLink}
