    ...
    <div className="bg-[#F7F8FA] text-[#17200F] font-inter">
      ...
      <section className="py-[clamp(64px,7vw,110px)] border-b border-border">
        <div className="max-w-[1240px] mx-auto px-5 sm:px-8 space-y-6 animate-fade-up">
          ...
          >
            From request to <span className="text-[#C9A227]">[permanent record.]</span>
          </h1>
      ...
      <section className="py-[clamp(64px,7vw,110px)] border-b border-border bg-[#F7F8FA]">
        <div className="max-w-[1240px] mx-auto px-5 sm:px-8">
          <div className="grid grid-cols-1 min-[700px]:grid-cols-2 min-[1080px]:grid-cols-4 gap-8">
            ...
            {/* Step 1 */}
            <div className="bg-white border border-border rounded-lg p-6 shadow-[0_10px_28px_rgba(60,55,30,0.10)] hover:-translate-y-1 hover:shadow-lg transition duration-200 ease-out space-y-4 select-none animate-fade-up">
              <span className="font-sans text-2xl font-bold text-[#C9A227]">1</span>
              <h3 className="font-sans text-lg font-bold text-[#17200F]">Raise</h3>
            ...
            {/* Step 2 */}
            <div className="bg-white border border-border rounded-lg p-6 shadow-[0_10px_28px_rgba(60,55,30,0.10)] hover:-translate-y-1 hover:shadow-lg transition duration-200 ease-out space-y-4 select-none animate-fade-up" style={{ animationDelay: '60ms' }}>
              <span className="font-sans text-2xl font-bold text-[#C9A227]">2</span>
              <h3 className="font-sans text-lg font-bold text-[#17200F]">Route</h3>
              <p className="text-xs text-[#4B5347] leading-relaxed">
            ...
            {/* Step 3 */}
            <div className="bg-white border border-border rounded-lg p-6 shadow-[0_10px_28px_rgba(60,55,30,0.10)] hover:-translate-y-1 hover:shadow-lg transition duration-200 ease-out space-y-4 select-none animate-fade-up" style={{ animationDelay: '120ms' }}>
              <span className="font-sans text-2xl font-bold text-[#C9A227]">3</span>
              <h3 className="font-sans text-lg font-bold text-[#17200F]">Decide</h3>
              <p className="text-xs text-[#4B5347] leading-relaxed">
            ...
            {/* Step 4 */}
            <div className="bg-white border border-border rounded-lg p-6 shadow-[0_10px_28px_rgba(60,55,30,0.10)] hover:-translate-y-1 hover:shadow-lg transition duration-200 ease-out space-y-4 select-none animate-fade-up" style={{ animationDelay: '180ms' }}>
              <span className="font-sans text-2xl font-bold text-[#C9A227]">4</span>
              <h3 className="font-sans text-lg font-bold text-[#17200F]">Prove</h3>
              <p className="text-xs text-[#4B5347] leading-relaxed">
        ...
        <div className="max-w-[1240px] mx-auto px-5 sm:px-8 space-y-12">
          ...
          <div className="text-center space-y-3 max-w-2xl mx-auto animate-fade-up">
            ...
            <h2 className="font-sans text-[clamp(28px,3.6vw,44px)] font-bold text-[#17200F] leading-[1.12]">
              A record that answers <span className="text-[#C9A227]">[five]</span> questions.
            </h2>
          </div>
          ...
          <div className="max-w-3xl mx-auto space-y-4 animate-fade-up" style={{ animationDelay: '60ms' }}>
            ...
            <div className="bg-white border border-border rounded-lg p-5 sm:p-6 shadow-[0_10px_28px_rgba(60,55,30,0.10)] hover:-translate-y-0.5 transition duration-150">
              <span className="font-mono text-[10px] font-bold uppercase tracking-wider text-[#C9A227] block mb-1">
                Authority
              </span>
              <h4 className="font-sans text-base font-bold text-[#17200F] mb-1.5">Did the right people approve?</h4>
              <p className="text-xs text-[#4B5347] leading-relaxed">
            ...
            <div className="bg-white border border-border rounded-lg p-5 sm:p-6 shadow-[0_10px_28px_rgba(60,55,30,0.10)] hover:-translate-y-0.5 transition duration-150">
              ...
              <h4 className="font-sans text-base font-bold text-[#17200F] mb-1.5">In what order?</h4>
              <p className="text-xs text-[#4B5347] leading-relaxed">
            ...
            <div className="bg-white border border-border rounded-lg p-5 sm:p-6 shadow-[0_10px_28px_rgba(60,55,30,0.10)] hover:-translate-y-0.5 transition duration-150">
              ...
              <h4 className="font-sans text-base font-bold text-[#17200F] mb-1.5">On what basis?</h4>
              <p className="text-xs text-[#4B5347] leading-relaxed">
            ...
            <div className="bg-white border border-border rounded-lg p-5 sm:p-6 shadow-[0_10px_28px_rgba(60,55,30,0.10)] hover:-translate-y-0.5 transition duration-150">
              ...
              <h4 className="font-sans text-base font-bold text-[#17200F] mb-1.5">Altered since?</h4>
              <p className="text-xs text-[#4B5347] leading-relaxed">
            ...
            <div className="bg-white border border-border rounded-lg p-5 sm:p-6 shadow-[0_10px_28px_rgba(60,55,30,0.10)] hover:-translate-y-0.5 transition duration-150">
              ...
              <h4 className="font-sans text-base font-bold text-[#17200F] mb-1.5">Will it survive the people and the tools?</h4>
              <p className="text-xs text-[#4B5347] leading-relaxed">
      ...
      {/* 4. FITS YOUR STACK SECTION (Dark background #101828) */}
        ...
        <div className="max-w-[1240px] mx-auto px-5 sm:px-8 space-y-12">
          ...
          <div className="text-center space-y-3 max-w-2xl mx-auto animate-fade-up">
            ...
            <h2 className="font-sans text-[clamp(28px,3.6vw,44px)] font-bold text-[#F7F8FA] leading-[1.12]">
              Keep your tools. Gain the <span className="text-[#C9A227]">[ledger.]</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/5 border border-border rounded-lg p-6 hover:-translate-y-1 transition duration-200 space-y-4 animate-fade-up">
              ...
              <h3 className="font-sans text-lg font-bold text-[#F7F8FA]">Open API</h3>
              <p className="text-xs text-[#F7F8FA]/80 leading-relaxed font-inter">
            ...
            <div className="bg-white/5 border border-border rounded-lg p-6 hover:-translate-y-1 transition duration-200 space-y-4 animate-fade-up" style={{ animationDelay: '60ms' }}>
              ...
              <h3 className="font-sans text-lg font-bold text-[#F7F8FA]">Ticket-friendly</h3>
              <p className="text-xs text-[#F7F8FA]/80 leading-relaxed font-inter">
            ...
            <div className="bg-white/5 border border-border rounded-lg p-6 hover:-translate-y-1 transition duration-200 space-y-4 animate-fade-up" style={{ animationDelay: '120ms' }}>
              ...
              <h3 className="font-sans text-lg font-bold text-[#F7F8FA]">Org-aware</h3>
              <p className="text-xs text-[#F7F8FA]/80 leading-relaxed font-inter">
          ...
          <div className="pt-8 border-t border-border text-center max-w-xl mx-auto animate-fade-up" style={{ animationDelay: '180ms' }}>
            <p className="text-[11px] font-mono tracking-wide text-[#F7F8FA]/65 leading-relaxed uppercase">
